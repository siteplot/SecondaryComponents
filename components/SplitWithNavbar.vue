        ...
        <nav class="hidden md:flex space-x-10">
          <div class="relative">
            ...
            <div class="absolute -ml-4 mt-3 transform z-10 px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
              <div class="hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
          ...
          <div class="relative">
            ...
            <!--
              ...
              Leaving: "transition ease-in duration-150"
                ...
                To: "opacity-0 translate-y-1"
            -->
            <div class="hidden absolute left-1/2 z-10 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md sm:px-0">
